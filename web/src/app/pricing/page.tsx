...
const PLANS = [
  { name: "FREE", label: "Free", price: 0, msg: "100", agents: "1", credentials: "3", api: true },
  { name: "PRO", label: "Pro", price: 5, msg: "20,000", agents: "25", credentials: "∞", api: true, popular: true },
]

const ROWS = [
  { label: "Messages / mo", key: "msg" },
  { label: "Agents", key: "agents" },
  { label: "API credentials", key: "credentials" },
    ...
    <div style={{ minHeight: "100vh", padding: "80px 24px" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 60 }}>
          ...
          <p style={{ color: "#71717a", fontSize: 15, marginBottom: 28 }}>All plans include a persistent Postal Zero address and messaging.</p>
        </div>

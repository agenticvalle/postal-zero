  ...
  return (
    <div style={{ maxWidth: 480, margin: "60px auto", padding: "0 24px" }}>
      ...
      <div style={{ background: "#111118", border: "1px solid #222", borderRadius: 8, padding: 14, fontSize: 12, color: "#9b9b7a", lineHeight: 1.6 }}>
        This receipt includes a cryptographic HMAC generated by Postal Zero. It can be used to verify the integrity and authenticity of the signed receipt data.
      </div>
